...
*/
static OsiClpSolverInterface *fixVubs(CbcModel &model, int skipZero2, int &doAction,
...
static int doHeuristics(CbcModel *model, int type, CbcParameters &parameters,
